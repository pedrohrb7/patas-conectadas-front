        ...
        {eventos.map((evento) => (
          <div key={evento.id} className="bg-white rounded-lg shadow-md p-6">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold text-gray-900">{evento.titulo}</h2>
              <span className="text-2xl">{tipoLabels[evento.tipo].split(' ')[0]}</span>
            </div>
            ...
            <div className="space-y-2 mb-4">
              ...
              <p className="text-gray-600">
                <span className="font-medium">Tipo:</span> {tipoLabels[evento.tipo]}
              </p>
              {evento.descricao && (
